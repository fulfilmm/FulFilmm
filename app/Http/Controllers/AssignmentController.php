    ...
    // {
        ...
        */
        public function edit(Assignment $assignment)
        {
            ...
            // $assignment = Assignment::with('assigned_groups', 'assigned_employees')->findOrFail($assignment->id);
            $employees = Employee::all()->pluck('name', 'id')->all();
            $groups = Group::all()->pluck('name', 'id');
            return view('assignment.edit', compact('assignment','employees','groups'));
        }
        ...
        */
        public function update(AssignmentRequest $request, $id)
        {
            ...
            $assignment->assigned_employees()->sync($data['assigned_employee'] ?? []);
            $assignment->assigned_groups()->sync($data['assigned_group'] ?? []);

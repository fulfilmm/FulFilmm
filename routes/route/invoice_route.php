...
Route::middleware(['auth:employee'])->group(function () {
    ...
    Route::post('order/assign/{id}', [SaleOrderController::class, 'assign'])->name('order.assign');Route::get('/invoice_vue' , [InvoiceDataController::class, 'index']) -> name('invoice_vue.index');

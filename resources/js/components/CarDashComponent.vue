                    ...
                    <table class="table table-striped">
                        ...
                        <tr v-for="car in cars" :key="car.id">
                            ...
                            <td>
                                ...
                                <div>
                                    <div v-if="! car.status.length" class=" text-success text-sm font-weight-bold">
                                        Working
                                    </div>
                                    ...
                                    <div v-else>
                                        <div v-for="s in car.status" :key="s.id">
                                            <div v-if="s.check == 0">
                                                <div v-if="s.status == 0" class="badge badge-warning rounded-pill">
                                                    Maintain
                                                </div>
                                                <div v-else-if="s.status == 1" class="badge badge-danger rounded-pill">
                                                    Repair
                                                </div>
                                            </div>
                                            <!-- <div v-else>
                            ...
                            <td class="">
                                <span class="badge badge-danger rounded-pill"
                                      v-if="car.license_renew_date <= lastMonth"> License Expire Soon</span>
                                    ...
                                    <div v-if="data.check == 0">
                                        <div v-for="d in JSON.parse(data.case)" :key="d.id">
                                            ...
                                            <small v-if="d.end_date <= lastMonth">
                                                <span class="font-weight-bolder"> {{ d.case}} </span> will expire at
                                                <span class="text-danger font-weight-bold"> {{ d.end_date }} </span>
                                            </small>
                            ...
                            <td>
                                <a :href="`/car-list/car-maintain/${car.id}`"
                            ...
                            <td>
                                <a :href="`/car-list/car-record/${car.id}`"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.license_no" class="form-control"
                                               placeholder=" Please Fill License Number" aria-describedby="helpId"
                                               required>
                                        <small class="text-danger font-weight-bold font-italic text-left"> Required
                                        </small>
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.brand" class="form-control"
                                               placeholder="Please Fill Car Brand" aria-describedby="helpId" required>
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.model" class="form-control"
                                               placeholder="Please Fill Car Model" aria-describedby="helpId" required>
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.manufacture" class="form-control"
                                               placeholder="Please Fill Manufacturing Company" aria-describedby="helpId"
                                               required>
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.engine" class="form-control"
                                               placeholder="Please Fill Engine Type" aria-describedby="helpId" required>
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.horsepower" class="form-control"
                                               placeholder="Please Fill Horsepower" aria-describedby="helpId" required>
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.chassis" class="form-control"
                                               placeholder="Please Fill Chassis" aria-describedby="helpId" required>
                                    </div>

                                    <div class="form-group col-md-6 col-sm-12">
                                        <input type="text" v-model="car.kilometer" class="form-control"
                                               placeholder="Please Fill Original Kilometer" aria-describedby="helpId">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="issue_date" class="mx-4"> License Issue Date</label><br>
                                            <date-picker v-model="car.license_issue_date" valueType="format"
                                                         placeholder="choose date"></date-picker>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="renew_date" class="mx-4"> License Renew Date </label><br>
                                            <date-picker v-model="car.license_renew_date" valueType="format"
                                                         placeholder="choose date"></date-picker>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="mr-sm-2" for="inlineFormCustomSelect">Please Add Fuel
                                                Types</label>
                                            <select class="form-control mr-sm-2" id="inlineFormCustomSelect"
                                                    v-model="car.fuel_type" required>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <input type="text" v-model="car.seat" class="form-control"
                                                   placeholder="Seat"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <input type="text" v-model="car.purchase_value" class="form-control"
                                                   placeholder="Purchase Value" aria-describedby="helpId">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" v-model="car.org_owner_name" class="form-control"
                                                           placeholder="Please Fill Original Owner Name"
                                                           aria-describedby="helpId">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="contract_date" class="mx-4"> Contract Date</label><br>
                                                    <date-picker v-model="car.contract_date" valueType="format"
                                                                 placeholder="choose date"></date-picker>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="issue_date" class="mx-4"> Contract Renew Date</label><br>
                                                    <date-picker v-model="car.renew_date" valueType="format"
                                                                 placeholder="choose date"></date-picker>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" v-model="car.description"
                                                              rows="3"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="button" class="btn btn-danger mx-3" data-dismiss="modal">Close
                                            Box
                                        </button>

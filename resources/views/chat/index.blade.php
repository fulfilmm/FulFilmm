    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-inner slimscroll">
            <div class="sidebar-menu">
                <ul>
                    <li>
                        <a href="{{url('/')}}"><i class="la la-home"></i> <span>Back to Home</span></a>
                    </li>
                   @foreach($allemp as $key=>$val)
                        <li>
                            <a href="" id="emp_{{$key}}">
                                ...
                                <span class="chat-user">{{$val}}</span> <span class="badge badge-pill bg-danger">1</span>
                            </a>
                        </li>
                        <script>
                            $(document).ready(function() {
                                $(document).on('click', "#emp_{{$key}}", function () {
                                    var emp={{$key}};
                                    $.ajax({
                                        type:'GET',
                                        data : {
                                        ...
                                        <div class="table-body">
                                            <div class="table-content">
                                                <div class="chat-profile-img">
                                                    ...
                                                    <h3 class="user-name m-t-10 mb-0">{{\Illuminate\Support\Facades\Auth::guard('employee')->user()->name}}</h3>
                                                ...
                                                <div class="chat-profile-info">
                                                    <ul class="user-det-list">
                                                        <li>
                                                            <span>Username:</span>
                                                            <span class="float-right text-muted">{{$auth->name}}</span>
                                                        </li>
                                                        <li>
                                                            <span>DOB:</span>

...
<head>
    ...
    <!-- BEGIN: Vendor CSS-->
    <link media="all" type="text/css" rel="stylesheet" href="http://rose.localhost/focus/app_end-ltr.css?id=192844a53499763dfa62">
...
</head>        <body class="vertical-layout vertical-menu-modern 2-columns   fixed-navbar" data-open="click"
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header border-bottom">
            <ul class="nav navbar-nav flex-row ">
                ...
                <li class="nav-item mr-auto"><a class="navbar-brand" href="#"><img src="{{$maincompany!=null ? url(asset('/img/profiles/'.$maincompany->logo)): url(asset('/img/profiles/avatar-01.jpg'))}}"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="{{route('customer.invoice')}}"
                                     class="menu-item  "><img src="{{url(asset('img/icon_image/invoice.png'))}}"  alt="" width="24px" height="24px" class="mr-1" ><span class="menu-title">Invoices</span></a>

            </li>


            <li class=" nav-item"><a href="{{route('customer.quotation')}}"
                                     class="menu-item "><img src="{{url(asset('img/icon_image/quotation.png'))}}"  alt="" class="mr-1"><span class="menu-title">Quote</span></a>

            </li>

            <li class=" nav-item"><a href="http://rose.localhost/crm/projects"
                                     class="menu-item "><img src="{{url(asset('img/icon_image/order24.png'))}}"  alt="" class="mr-1"><span class="menu-title">Order</span></a>

            </li>

            <li class=" nav-item"><a href="{{route('request_tickets.create')}}"
                                     class="menu-item "><img src="{{url(asset('img/icon_image/complaint.png'))}}"  alt="" class="mr-1"><span class="menu-title">Complain</span></a>

<x-partials.modal id="project_budget-create" title="Create Project Budget">
    <form action="{{ route('project_tasks.store') }}" method="POST">
        @csrf
        <input type="hidden" name="project_id" value="{{ $project->id }}">
        <input type="hidden" name="keyword" value="proposed_budget">
        <x-forms.basic.input name="name" type="text" value="" title="Budget Name" required></x-forms.basic.input>
        ...
        <div class="float-left mr-auto">
            <div class="add-task-btn-wrapper">
                <span class="add-task-btn btn btn-white btn-sm" data-toggle="modal"
                      data-target="#project_budget-create"> Add Budget </span>
            </div>
        </div>
        ...
        <div class="task-list-container">
            <div class="task-list-body">
                ...
                <ul id="task-list">
                    ...
                    @forelse ($project->proposed_budget as $task)
                        <li class="task">
                    ...
                    @empty
                        <li class="task">
                            <div class="task-container">
                            <span class="task-label"
                                  contenteditable="false">There is no budget yet.</span>
                            </div>
                        </li>
                    @endforelse

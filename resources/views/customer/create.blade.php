                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <div class="card-body rounded bg-light">
                                    <div class="d-flex justify-content-center mt-5">
                                        <div class="text-center my-2" >
                                            ...
                                            <img id="output" onClick="openSelect('#file1')" class="rounded mt-2 mb-4" src="{{isset($employee)?(url(asset($employee->profile_img?'img/profiles/'.$employee->profile_img:'img/profiles/plus.jpg'))):url(asset('/img/profiles/plus.jpg'))}}" width="100px" height="100px;" alt=""><br>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-3">
                                    ...
                                    <textarea name="bio" class="form-control" id="bio" rows="10" placeholder="Enter Bio"></textarea>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="row g-3 date-icon-set-modal">
                                    ...
                                    <div class="col-md-6 mb-3 position-relative">
                                        <div class="form-group">
                                           ...
                                           <div class="input-group">
                                               <input type="date" class="form-control vanila-datepicker datepicker-input" id="bod" name="bod" placeholder="Enter Birth Day" autocomplete="off">
                                           </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="report_to" name="report_to" placeholder="Enter report person name">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="position" class="form-label font-weight-bold text-muted text-uppercase">Report Person's Position</label>
                                        <input type="text" class="form-control" id="position" name="position" placeholder="Enter report person's position">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="fb" name="facebook" placeholder="Enter facebook link">
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="checkbox" name="canlogin" id="canlogin" ><label for="canlogin" class="ml-1">Can login</label>
                                    </div>
                                </div>
                            </div>
                        </div>

            ...
            <div class="col-md-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="home-tab" data-toggle="tab" data-target="#todo" type="button" role="tab" aria-controls="home" aria-selected="true">Todo List</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="profile-tab" data-toggle="tab" data-target="#assignment" type="button" role="tab" aria-controls="profile" aria-selected="false">Assignments</button>
                    </li>
                </ul>

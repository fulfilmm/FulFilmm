...
@section("content")
    ...
    <div class="content container-fluid">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#variant" role="tab"
                   aria-controls="profile"
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="variant" role="tabpanel" aria-labelledby="home-tab">
                <table class="table">
                    <thead>
                    <tr>
                        <th>SKU Code</th>
                    ...
                    @foreach($sku as $skus)
                       <tr>
                           <td>{{$skus->sku}}</td>
                            <td>    @foreach($sku_value as $value)
                                    @if($skus->id==$value->sku_id)

                                        {{$value->variant->name}}:{{$value->variant_value->value}}

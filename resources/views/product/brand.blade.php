        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="#" class="btn btn-white float-right mr-3 mt-3 shadow rounded-pill" data-toggle="modal" data-target="#createBrand" style="box-shadow: white"><i class="fa fa-plus mr-2"></i>Add Brand</a>
                </div>
            </div>
        </div>
        <!-- /Page Header -->

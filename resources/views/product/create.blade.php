                    ...
                    <div class="col-12 my-3">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-6">
                                <div class="form-group"><label for="price">Price</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fa fa-money"></i></span>
                                        </div><input type="number" class="form-control" name="price[]">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                            ...
                            <div class="text-center"><div class="form-group col-md-4 offset-md-3">
                                    <img id="output" class="rounded mt-3 output" src="{{url(asset("/img/profiles/avatar-01.jpg"))}}" width="100px" height="100px;">
                                </div>

...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Shop Edit</h3>
                    <ul class="breadcrumb">
                ...
                <div class="col-3">
                    <form action="{{route('shop.update',$shop->id)}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="contact" value="{{$shop->contact}}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="location" name="location" value="{{$shop->location}}" readonly>
                        </div>
                        <div class="form-group">

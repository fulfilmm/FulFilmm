                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <select name="payment_method" id="payment" class="form-control">
                                    <option value="Cash" {{$bill->payment_method=='Cash'?'selected':''}}>
                                        Cash
                                    </option>
                                    <option value="Bank" {{$bill->payment_method=='Bank'?'selected':''}}>
                                        Bank
                                    </option>
                                    <option value="KBZ Pay" {{$bill->payment_method=='KBZ Pay'?'selected':''}}>
                                        KBZPay
                                    </option>
                                    <option value="Wave Money" {{$bill->payment_method=='Wave Money'?'selected':''}}>
                                        Wave Money
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="bill_date"  id="bill_date" value="{{\Carbon\Carbon::parse($bill->bill_date)->format('Y-m-d')}}">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="due_date" type="date" id="due_date" value="{{\Carbon\Carbon::parse($bill->due_date)->format('Y-m-d')}}">
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                <label for="vendor_id">Vendor <span class="text-danger">*</span></label>
                                <input type="text"  id="vendor_id" class="form-control" value="{{$bill->supplier->name}}" readonly>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" name="vendor_email" id="vendor_email"
                                       value="{{$bill->supplier->email}}" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="more_info" name="other_info">{{$bill->other_information}}</textarea>
                            </div>
                        </div>
                    </div>

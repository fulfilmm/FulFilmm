...
@section('content')
    ...
    <div class="content container-fluid">
                            ...
                            <div class="text-right">
                                <div class="dropup header-drop-top">
                                    ...
                                    <div role="menu" class="dropdown-menu">
                                        ...
                                        <button type="button" title="Delete" data-toggle="modal" data-target="#delete{{$bill->id}}" class="dropdown-item action-delete">
        ...
        <div class="row mt-3" style="font-size: inherit !important;">
            <div class="col-md-2">
                Status
                <br> <strong><span class="float-left"><span class="text-dark badge badge-{{$bill->status=='Paid'?'success':($bill->status=='Partial'?'warning':($bill->status=='Daft'?'white':'danger'))}}">
                       {{$bill->status}}

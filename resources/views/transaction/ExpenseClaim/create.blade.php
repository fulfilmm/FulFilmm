...
@section('content')
    ...
    <form method="POST" action="{{route('expenseclaims.store')}}" id="transaction"  enctype="multipart/form-data">
        @csrf
       <div class="card shadow">
               ...
               <div class="row">
                   <div class="col-md-6">
                       <div class="form-group">
                           ...
                           <input type="text" name="main_title" class="form-control" id="title" value="{{old('main_title')}}" required>
                           @error('main_title')
           ...
           <div class="row save-buttons mb-3">

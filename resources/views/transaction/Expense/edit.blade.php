            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item float-right">Edit Expense</li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="card shadow">
            <form method="POST" action="{{route('expense.update',$expense->id)}}" accept-charset="UTF-8" id="transaction" role="form" novalidate="novalidate" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="date" name="transaction_date" class="form-control" value="{{\Carbon\Carbon::parse($expense->transaction_date)->format('Y-m-d')}}">
                            </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="customer_id" id="customer_id" class="form-control">
                                        ...
                                        @foreach($data['customers'] as $customer)
                                            <option value="{{$customer->id}}" {{$expense->vendor_id==$customer->id?'selected':''}}>{{$customer->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('customer_id')
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="payment_method" id="payment_method" class="form-control ">
                                        @foreach($data['payment_method'] as $payment_method)
                                            <option value="{{$payment_method}}" {{$expense->payment_method==$payment_method?'selected':''}}>{{$payment_method}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="approver">Casher</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-user"></i></span>
                                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group"><label for="reference">Reference</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="reference" id="reference" value="{{$expense->reference}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">

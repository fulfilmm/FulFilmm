...
@section('content')
    <style>
        #retail_invoice_filter,#whole_invoice_filter{
            display: none;
        }
    </style>
        ...
        <div class="card shadow">
           <div class="col-12">
               <div class="row border-bottom">
                  <div class="col-12">
                      <ul class="nav nav-pills my-2 border-rounded" id="pills-tab" role="tablist">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.whole_total').each(function () {
                wholesum += parseFloat($(this).val());
            });
            $('#whole_grand').text(wholesum);
            var retailsum = 0;
            $('.retail_total').each(function () {
                retailsum += parseFloat($(this).val());
            });
            $('#retail_grand').text(wholesum);
            $('select').select2();
            $('#stock').DataTable({
                dom: 'Bfrtip',
                buttons: [

                        ...
                        <div class="row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-white" data-toggle="modal"
                                                    data-target="#add_contact"><i class="la la-plus"></i></button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12 ">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control shadow-sm" id="more_info">{{$data[0]['more_info']??''}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow">
                    <div class="col-12">
                        ...
                        <div class="form-group col-md-12 mt-4">
                            <input type="radio" class="mr-1" name="delionoff" id="on" value="on" checked><label for="">Delivery Fee</label><br>
                            <input type="radio" class="mr-1" name="delionoff" id="off" value="off"><label for="">Not Delivery Fee</label>
                        </div>
                    </div>
                </div>
                <div class="card shadow">
                    <div class="col-12 my-3">
                        <button class="btn btn-primary m-r-10 my-3 col-12" type="button" id="saveAndsend">Save & Send</button>
                                ...
                                <div class="row">
                                                    ...
                                                    <select name="" id="variant" class="form-control" style="width: 80%">
                                                        ...
                                                        @foreach($aval_product as $item)
                                                            <option value="{{$item->variant->id}}"
                                                                    ...
                                                                    data-option="{{$item->warehouse_id}}">{{$item->variant->product_name}}{{isset($item->variant->variant)?"(".$item->variant->variant.")":''}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="input-group-append">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="amount_discount" value="1">
                                            <label for="">ON</label>
                                            <input type="radio" name="amount_discount" checked value="0">
                                            <label for="">Off</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <table class="table table-hover table-white table-bordered" id="order_table">
                                ...
                                @foreach($orderline as $order)
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control" id="aval{{$order->id}}" readonly>
                                        </td>
                                        <td>
                                            <div class="col-12">
                                                <div class="row">
                                    ...
                                    {{--                                @dd($unit_price)--}}
                                   @include('invoice.invoicejquerycode')
                                @endforeach
                                ...
                                <tr>
                                    ...
                                    <td id="discount_div" colspan="2">
                                        <div class="input-group">
                                            <input class="form-control" type="text"
                                                   id="discount" value="0.0">
                                            <div class="input-group-append">
                                                <button class="btn btn-white" id="percentage">0%</button>
                                            </div>
